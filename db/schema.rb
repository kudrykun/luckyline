...
ActiveRecord::Schema.define(version: 20170904003507) do
  ...
  create_table "decoration_pictures", force: :cascade do |t|
    t.string   "alt"
    t.string   "caption"
    ...
    t.index ["gallery_id"], name: "index_decoration_pictures_on_gallery_id", using: :btree
  end

  create_table "description_pictures", force: :cascade do |t|
    t.string   "alt"
    t.string   "caption"
    t.string   "image_file_name"
    t.string   "image_content_type"
    ...
    t.datetime "image_updated_at"
    t.integer  "gallery_id"
    t.index ["gallery_id"], name: "index_description_pictures_on_gallery_id", using: :btree
  end
  ...
  add_foreign_key "decoration_pictures", "galleries"
  add_foreign_key "description_pictures", "galleries"
